...
export const DEFAULT_BRAND_MODULES = {
  ...
  tv: {
    eyebrow: 'SkillSync Ai TV',
    title: 'SkillSync AI TV',
    description: 'Editorial programming and video series tied to your current learning arc.',
    detail_title: 'SkillSync AI TV',
    detail_quote: 'Series, rails, and premium learning channels without operator-language leakage.',
  },
  flash_cards: {
    eyebrow: 'Flash Cards',
    title: 'Flash Cards',
    description: 'Short review decks sourced from your current plan and episode themes.',
    detail_title: 'Flash Cards',
    detail_quote: 'Quick recall, confidence checks, and repetition without busywork.',
  },
  brief: {
  ...
  events: {
    ...
    description: 'Relevant events, saved-interest signals, and concierge follow-up moments.',
    detail_title: 'Events & Networking',
    detail_quote: 'A curated event rail that supports momentum without pretending unsupported RSVP flows.',
  },
  telescope: {
    eyebrow: 'Telescope',
    title: 'Telescope',
    description: 'Adjacent roles, market signals, and next-step horizons from now to later.',
    detail_title: 'Telescope',
    detail_quote: 'A horizon view for opportunity paths, not a generic job board.',
  },
  team: {
    eyebrow: 'SkillSync AI Team',
    title: 'SkillSync AI Team',
    description: 'Who helps, when AI leads, and when human concierge support should step in.',
    detail_title: 'SkillSync AI Team',
    detail_quote: 'A high-trust explanation of the support roster without exposing admin machinery.',
  },
  cjs_execution: {
