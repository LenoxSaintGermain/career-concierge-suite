...
| E06-S04 Smart Start Resume Reference Bridge | E06 | P2 | Done | Paid Smart Start now converts real resume URLs into deduped `intake_reference` CJS assets, keeps uploaded files prioritized for review, and makes the lighter evidence class explicit in the UI. |
