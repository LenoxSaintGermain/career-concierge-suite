...
| `MTL-12` Agentic staff operating model + orchestration control plane | In Progress | Staff registry, policy graph, orchestration runs, and admin control-plane visibility are live; escalation depth and richer evaluation telemetry still remain | `E10-S01`, `E10-S02`, `E10-S03`, `E10-S04`, `E10-S05`, `E10-S06`, `E10-S07` | `TU1`, `TU2`, `TU3`, `TU4` |
...
- `MTL-12`: staffing/orchestration implementation is now active. Admin governance shows roster, policy, and recent runs; Chief of Staff plus Content Director runs now write richer Firestore records with confidence/evidence fields. Human escalation flow depth and fuller evaluator telemetry are still open.
