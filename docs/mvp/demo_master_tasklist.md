...
| `MTL-11` Content Director media orchestration + reusable library pipeline | In Progress | Phase A planning seed, taxonomy-guided tagging, starter-library seeding, and the plan-backed library-first resolver are live; async jobs, storage architecture, and admin pipeline ops remain | `E09-S01`, `E09-S02`, `E09-S03`, `E09-S04`, `E09-S05`, `E09-S06`, `E09-S07` | `TU1`, `TU2`, `TU3`, `TU4` |
...
- `MTL-11`: `E09-S01`, `E09-S02`, and `E09-S03` are live; suite generation seeds planning docs in Firestore, admin exposes structured taxonomy shortcuts plus a one-click starter media pack, and `/v1/media/library` now writes a library-first resolution summary back into orchestration runs. Async pipeline work, storage architecture, and admin media ops remain queued.
